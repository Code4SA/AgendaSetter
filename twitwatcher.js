...
mongoose.connect('mongodb://localhost/agendasetter');
...
var get_list = function(slug, owner_screen_name) {
	...
	T.get('lists/statuses', { slug: slug, owner_screen_name: owner_screen_name }, function(err, tweets, response) {
...
setInterval(get_next_list, 1000 * 120);